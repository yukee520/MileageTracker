...
echo "🔧 Fixing group downgrade issues..."

# Backup App.js
cp App.js App.js.backup.fix

# Apply the fixes
cat > fix_app.js << 'FIXEOF'
const fs = require('fs');
...
echo ""
echo "📝 Changes made:"
echo "1. performTierUpgrade now removes users from group when downgrading"
echo "2. handleUpgradeTier now confirms group downgrade with warning"
echo "3. All members are removed from group when admin downgrades"
echo ""
echo "🚀 Push to GitHub:"
echo "git add App.js"
echo "git commit -m 'Fix: Proper group downgrade handling'"
